...
pub struct MessageRow {
    ...
    /// Persisted parent message id for replies.
    #[sqlmodel(nullable)]
...
/// Persistent terminal-window identity imported from the Python service.
#[derive(Model, Debug, Clone, Serialize, Deserialize)]
#[sqlmodel(table = "window_identities")]
pub struct WindowIdentityRow {
    #[sqlmodel(primary_key, auto_increment)]
    pub id: Option<i64>,
    pub project_id: i64,
...
impl Default for WindowIdentityRow {
    fn default() -> Self {
        let now = now_micros();
        Self {
            id: None,
            project_id: 0,
            window_uuid: String::new(),
...
/// Persisted project-wide summary generated by `summarize_recent`.
#[derive(Model, Debug, Clone, Serialize, Deserialize)]
#[sqlmodel(table = "message_summaries")]
pub struct MessageSummaryRow {
    #[sqlmodel(primary_key, auto_increment)]
    pub id: Option<i64>,
    pub project_id: i64,
...
impl Default for MessageSummaryRow {
    fn default() -> Self {
        let now = now_micros();
        Self {
            id: None,
