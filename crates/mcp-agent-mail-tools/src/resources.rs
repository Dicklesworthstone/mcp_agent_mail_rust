    ...
    let mut clusters = vec![
        ...
        ToolCluster {
            ...
            tools: vec![
                ...
                ToolDirectoryEntry {
                    name: "list_window_identities".to_string(),
                    summary: "List active registered window identities for a project.".to_string(),
                    use_when: "Auditing per-window identities or recovering coordination state after a restart.".to_string(),
                    related: vec!["create_agent_identity".to_string(), "register_agent".to_string()],
                    expected_frequency: "During identity audits and restart recovery.".to_string(),
                    required_capabilities: vec!["identity".to_string()],
                    usage_examples: vec![ToolUsageExample { hint: "Window roster".to_string(), sample: "list_window_identities(project_key='backend')".to_string() }],
                    capabilities: vec!["identity".to_string()],
                    complexity: "low".to_string(),
                },
                ToolDirectoryEntry {
                    name: "sweep_stale_agents".to_string(),
                    summary: "Retire abandoned project agents using a conservative inactivity threshold.".to_string(),
                    use_when: "Cleaning an active roster without retiring the caller or reservation holders.".to_string(),
                    related: vec!["retire_agent".to_string(), "list_agents".to_string()],
                    expected_frequency: "During periodic identity maintenance.".to_string(),
                    required_capabilities: vec!["identity".to_string(), "file_reservations".to_string()],
                    usage_examples: vec![ToolUsageExample { hint: "Roster cleanup".to_string(), sample: "sweep_stale_agents(project_key='backend', agent_name='BlueLake', threshold_seconds=86400)".to_string() }],
                    capabilities: vec!["identity".to_string(), "file_reservations".to_string()],
                    complexity: "medium".to_string(),
                },
                ToolDirectoryEntry {
        ...
        ToolCluster {
            ...
            tools: vec![
                ...
                ToolDirectoryEntry {
                    name: "summarize_recent".to_string(),
                    summary: "Summarize recent project-wide messages and persist the result for later retrieval.".to_string(),
                    use_when: "Producing a cross-thread project digest at a handoff or checkpoint.".to_string(),
                    related: vec!["fetch_summary".to_string(), "summarize_thread".to_string()],
                    expected_frequency: "At project checkpoints and session handoffs.".to_string(),
                    required_capabilities: vec!["search".to_string(), "summarization".to_string()],
                    usage_examples: vec![ToolUsageExample { hint: "Recent digest".to_string(), sample: "summarize_recent(project_key='backend', since_hours=1)".to_string() }],
                    capabilities: vec!["search".to_string(), "summarization".to_string()],
                    complexity: "medium".to_string(),
                },
                ToolDirectoryEntry {
                    name: "fetch_summary".to_string(),
                    summary: "Retrieve stored project-wide summaries from a recent time window.".to_string(),
                    use_when: "Reading an existing project digest without recomputing it.".to_string(),
                    related: vec!["summarize_recent".to_string()],
                    expected_frequency: "During handoffs and project status checks.".to_string(),
                    required_capabilities: vec!["read".to_string(), "summarization".to_string()],
                    usage_examples: vec![ToolUsageExample { hint: "Stored digest".to_string(), sample: "fetch_summary(project_key='backend', since_hours=24, limit=5)".to_string() }],
                    capabilities: vec!["read".to_string(), "summarization".to_string()],
                    complexity: "low".to_string(),
                },
                ToolDirectoryEntry {
