...
pub fn execute_search(
    ...
    // Fetch more results than needed to handle offset while counting the full
    // matching set for pagination metadata.
    ...
    // (newer documents first), then apply pagination to the stable ordering.
