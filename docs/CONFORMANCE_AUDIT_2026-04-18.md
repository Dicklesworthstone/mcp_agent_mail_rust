...
| list_window_identities | yes | focused | python-parity | tests/conformance/fixtures/tool_descriptions.json | Python description/schema parity plus focused DB coverage for active/expired identity filtering. |
| sweep_stale_agents | yes | focused | python-parity | tests/conformance/fixtures/tool_descriptions.json | Python description/schema parity plus focused DB coverage for caller exclusion and active-reservation protection. |
...
| summarize_recent | yes | focused | python-parity | tests/conformance/fixtures/tool_descriptions.json | Python description/schema parity plus focused summary response and persistence coverage. |
| fetch_summary | yes | focused | python-parity | tests/conformance/fixtures/tool_descriptions.json | Python description/schema parity plus focused cache and newest-first retrieval coverage. |
