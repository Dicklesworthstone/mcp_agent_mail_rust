...
VALUES (1, 'fixture-project', '/tmp/agent-mail-corruption-fixture', 1700000000000000);
INSERT INTO agents (id, project_id, name, program, model, task_description, created_ts)
VALUES (1, 1, 'FixtureAgent', 'fixture', 'fixture-model', 'corruption corpus', 1700000000000001);
INSERT INTO messages (
    id, project_id, sender_id, thread_id, subject, body_md,
    importance, ack_required, created_ts, recipients_json, attachments
)
VALUES (
    1, 1, 1, 'fixture-thread', 'Fixture message', 'Fixture body',
    'normal', 0, 1700000000000002, '{"to":["FixtureAgent"]}', '[]'
);
